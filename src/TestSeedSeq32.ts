...
function testSeedSeq32(): void {
    let container = document.getElementById("seq-test-result");
    if (container === null) throw Error("Could not find the div element with ID 'seq-test-result'");
